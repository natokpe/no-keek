        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    ...
                    <h2 class="mt-5 mb-4 pt-3 text-center">Verify Your Email</h2>

                    <div class="pt-3">
                        <h3 class="card-title text-start">Check Your Inbox</h3>
                        <p>We have sent a verification link to your email address. Click the link in the email to verify your email.</p>

                        <p><a href="<?= get_page_link(Theme::page('account')) ?>" tabindex="1">Resend email</a></p>
